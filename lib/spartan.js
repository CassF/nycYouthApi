...
class SpartanLib {
    ...
    **/
    static editOneSpartan(req, res) {
        // Spartan.findOneAndUpdate({ _id: req.params.id }, { "$set": { firstName: req.body.firstName, lastName: req.body.lastName, dob: req.body.dob, class: req.body.class, address: req.body.address, email: req.body.email, 
        // phoneNumber: req.body.phoneNumber, emergencyContactName: req.body.emergencyContactName, emergencyContactNo : req.body.emergencyContactNo, instructor : req.body.instructor, admin: req.body.admin, slackHandle : req.body.slackHandle } }).exec(function (err, spartan) {
        //     if (err) {
        //         console.log(err);
            ...
            (resolve, reject) => {
                Spartan.findById(req.params.id, (err, spartan) => {
                    ...
                    if (err) {
                        ...
                        spartan.dob = moment(req.body.dob, 'DD/MM/YYYY', false).format() || spartan.dob;
